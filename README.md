...
Easy way:
- Enable the ADR mode on the RPi: LMIC_setAdrMode(1)
TTN will automatically enable the ADR protocol as the ADR bit is set to 1.

Not-so-easy way:
- Implement ADR by yourself (see https://www.linuxembedded.fr/2017/12/introduction-a-lora/)
Useful function: LMIC_setLinkCheckMode(1), which will enable TTN to send ACKs.
